function preload() {
   ...
   this.load.image('obstáculo', 'assets/platform.png');
...
platform.create(300,380,'obstáculo').setScale(1.5);

platform.create(50, 150,'obstáculo');
platform.create(550, 250,'obstáculo');
